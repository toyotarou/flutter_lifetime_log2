...
class StampRallyMetroPokepokeListAlert extends ConsumerStatefulWidget {
  const StampRallyMetroPokepokeListAlert({super.key});

  @override
  ConsumerState<StampRallyMetroPokepokeListAlert> createState() => _StampRallyMetroPokepokeListAlertState();
}

class _StampRallyMetroPokepokeListAlertState extends ConsumerState<StampRallyMetroPokepokeListAlert>
    with ControllersMixin<StampRallyMetroPokepokeListAlert> {
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text('全${appParamState.keepStampRallyMetroPokepokeMap.length}回'),
  ...
  Widget displayStampRallyModelList() {
    ...
    final List<MapEntry<String, List<StampRallyModel>>> sortedEntries =
        appParamState.keepStampRallyMetroPokepokeMap.entries.toList()..sort(
