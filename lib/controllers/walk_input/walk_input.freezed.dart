...
/// @nodoc
abstract class $WalkInputStateCopyWith<$Res> {
  factory $WalkInputStateCopyWith(
          WalkInputState value, $Res Function(WalkInputState) then) =
      _$WalkInputStateCopyWithImpl<$Res, WalkInputState>;
  @useResult
  $Res call({List<WalkModel> walkList, Map<String, WalkModel> walkMap});
}

/// @nodoc
class _$WalkInputStateCopyWithImpl<$Res, $Val extends WalkInputState>
    implements $WalkInputStateCopyWith<$Res> {
  _$WalkInputStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$WalkInputStateImplCopyWith<$Res>
    implements $WalkInputStateCopyWith<$Res> {
  factory _$$WalkInputStateImplCopyWith(_$WalkInputStateImpl value,
          $Res Function(_$WalkInputStateImpl) then) =
      __$$WalkInputStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({List<WalkModel> walkList, Map<String, WalkModel> walkMap});
}
...
/// @nodoc
class __$$WalkInputStateImplCopyWithImpl<$Res>
    extends _$WalkInputStateCopyWithImpl<$Res, _$WalkInputStateImpl>
    implements _$$WalkInputStateImplCopyWith<$Res> {
  __$$WalkInputStateImplCopyWithImpl(
  ...
  $Res call({
    ...
    return _then(_$WalkInputStateImpl(
      walkList: null == walkList
          ? _value._walkList
          : walkList // ignore: cast_nullable_to_non_nullable
              as List<WalkModel>,
...
class _$WalkInputStateImpl implements _WalkInputState {
  const _$WalkInputStateImpl(
  ...
  @override
  String toString() {
    return 'WalkInputState(walkList: $walkList, walkMap: $walkMap)';
  }
  ...
  _$$WalkInputStateImplCopyWith<_$WalkInputStateImpl> get copyWith =>
      __$$WalkInputStateImplCopyWithImpl<_$WalkInputStateImpl>(
          this, _$identity);
}

abstract class _WalkInputState implements WalkInputState {
  const factory _WalkInputState(
      {final List<WalkModel> walkList,
      final Map<String, WalkModel> walkMap}) = _$WalkInputStateImpl;
