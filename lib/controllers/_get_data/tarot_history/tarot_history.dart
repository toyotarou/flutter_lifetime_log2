...
class TarotHistory extends _$TarotHistory {
  ...
  Future<TarotHistoryState> fetchAllTarotHistoryData() async {
    ...
    try {
      ...
      final dynamic value = await client.post(path: APIPath.tarothistory);
      final List<dynamic> data = (value as Map<String, dynamic>)['data'] as List<dynamic>;

      for (final dynamic item in data) {
        final TarotHistoryModel val = TarotHistoryModel.fromJson(item as Map<String, dynamic>);
      ...
      utility.showError('予期せぬエラーが発生しました（tarot_history）', error: e);
